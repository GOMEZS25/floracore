...
const { crearLote, listarLotes, actualizarLote, eliminarLote, adicionarCantidad, obtenerReservasLotes } = require('../controllers/lot.controller');
...
router.get('/reservations', verificarToken, checkPermission('INVENTORY', 'can_view'), obtenerReservasLotes);
